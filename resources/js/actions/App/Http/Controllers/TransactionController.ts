...
* @see app/Http/Controllers/TransactionController.php:238
...
* @see app/Http/Controllers/TransactionController.php:163
* @route '/api/transactions/{id}'
*/
...
* @see app/Http/Controllers/TransactionController.php:216
* @route '/api/transactions/{id}'
*/
